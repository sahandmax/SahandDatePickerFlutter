...
class PickerMasterState extends State<PickerMaster> {
  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      Container(child: Text("انتخاب تاریخ",style: TextStyle(fontSize: widget.fontSize.toDouble()),),margin: EdgeInsets.only(top: 10,bottom: 10),),
      monthOrganizer(month: widget.month , year: widget.year,fontSize: widget.fontSize,extraHeight: widget.extraHeight,),
